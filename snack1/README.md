...
2. Utilizzo map per creare un nuovo array contenente un oggetto per ogni vip con gli attributi richiesti. A map passo due variabili, una per l'elemento corrente e una per l'indice.
